"""Dataset Nutrition Label: Python-first packet analyzer."""
...
PROJECT = {
  "slug": "dataset-nutrition-label",
  "title": "Dataset Nutrition Label",
  "version": "2.0.0",
  "tagline": "Machine-readable labels for AI dataset risk, license, consent, and coverage.",
  "problem": "Dataset documentation is inconsistent, hard to compare, and often absent from automated pipelines.",
  "solution": "A label validator that enforces structured documentation for composition, collection method, consent, license, limitations, and intended use.",
  "required": [
    "dataset.name",
    "dataset.version",
    "collection.method",
